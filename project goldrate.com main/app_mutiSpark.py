...
try:
    # Khởi tạo SparkSession với các máy ảo
    spark = SparkSession.builder.master("spark://26.125.53.178:7077")\
...
def predict_gold_price(model, date_input):
    try:
        ...
        random_multiplier = 1.34 if year <= 2024 else 1.56  # Điều chỉnh giá dựa trên năm
